...
package frc.team6352;

import frc.team6352.commands.MovePowerCubeLiftDown;
import frc.team6352.commands.MovePowerCubeLiftToSwitch;
import frc.team6352.commands.MovePowerCubeLiftUp;
import frc.team6352.commands.ResetLiftEncoder;
import frc.team6352.commands.SuckInOrSpitOutPowerCube;
...
public class OI {
    ...
    public final static String dashboardIntelliJVersion = "Has the new code been deployed?";
    ...
    public OI()
    {
        ...
        SmartDashboard.putString(dashboardIntelliJVersion, "YES");
